  ...
  return (
    <div className="menu-container">
      <form className="auth-box" onSubmit={handleLogin}>
        ...
        <input type="email" placeholder="Email (CloneFest2025@email.com)" value={email} onChange={(e) => setEmail(e.target.value)} required />
        <input type="password" placeholder="Password (CloneFest2025)" value={password} onChange={(e) => setPassword(e.target.value)} required />
